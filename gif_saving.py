# THIS CODE WAS TAKEN FROM https://stackoverflow.com/questions/60948028/python-pillow-transparent-gif-isnt-working,
# ALL CREDIT GOES THE ADAPTER AS WELL AS THE ORIGINAL AUTHOR AT https://github.com/python-pillow/Pillow/issues/4644
